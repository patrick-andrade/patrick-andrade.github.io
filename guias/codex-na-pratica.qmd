...
description: "Do chat no navegador para o Codex no aplicativo desktop, com a pasta do projeto como referência."
toc: true
...
No chat do navegador, a rotina costuma ser anexar um arquivo, pedir uma transformação, baixar o resultado e repetir.

No Codex do aplicativo desktop, a **pasta** vira a referência do trabalho e cada **chat** registra uma tarefa.
...
- Fica uma versão no disco, sem o ciclo anexar / baixar / "qual é o arquivo certo?".
- O Explorador de Arquivos continua sendo o lugar dos arquivos.
...
- Tarefas com julgamento, ambiguidade ou risco pedem modelo e esforço maiores.
...
- Menos contexto irrelevante, e menos tokens.
...
Quando a tarefa pede o Chrome já autenticado ou um clique de sistema, o guia [Por que o Codex ainda importa](codex-ainda-importa.qmd) compara o harness com o Cursor.
